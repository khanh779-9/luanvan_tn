...
export default function GVPBPhanBienPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold text-slate-900 mb-6">Chấm điểm Phản biện</h1>
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-slate-50">
              ...
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Điểm Phản biện</th>
                ...
                return (
                  <tr key={deTai.maDeTai} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-sm text-slate-700 border-t border-slate-100 text-left align-middle">
                      {deTai.diemPhanBien !== undefined && deTai.diemPhanBien !== null
                        ? <span className="font-semibold text-blue-600">{deTai.diemPhanBien}</span>
                        : <span className="text-slate-400 italic">Chưa có</span>}
                    </td>
                    <td className="px-4 py-3 text-sm text-slate-700 border-t border-slate-100 align-middle">
                      <button
                  ...
                  updateMut.mutate({
                    ...
                    data: {
                      ...
                      data_json: {
                        ...
                        // Nếu muốn giữ nguyên dữ liệu gvhd thì lấy từ editDeTai.data_json.gvhd nếu có
